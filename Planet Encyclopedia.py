...
def PlanetInfo():
    ...
    if planet == "Mercury":
        ...
        label_planet_gravity_radius['text'] = "Gravity : 3.7m/s /n Radius : 2,439.7 km"
        label_planet_info['text'] = "Mercury is the smallest planet in our solar system. Its just a little bigger that Earth's Moon"
        
    elif planet == "Venus":
        label_planet_name['text'] = "Venus"
        label_planet_image['image'] = Venus
        label_planet_gravity_radius['text'] = "Gravity : 8.87m/s /n Radius : 6,051.8 km"
        ...
        label_planet_gravity_radius['text'] = "Gravity : 9.807m/s /n Radius : 6,371 km"
        label_planet_info['text'] = "Earth is the only place in the known universe confirmed to host life and its the only one known for sure to have liquid water on its surface."
